...
from main import computer_text_generator, background_generator, distorsion_generator
from main.utils import mask_to_bboxes
...
class FakeTextDataGenerator(object):
    ...
    def generate(
        ...
        image = None
        import random
        # margin_top, margin_left, margin_bottom, margin_right = (random.randint(0,10),random.randint(0,10),random.randint(0,10),random.randint(0,10))#margins
