...
from main.data_generator import FakeTextDataGenerator
from main.string_generator import (create_strings_from_dict,
                                   create_strings_from_file,
                                   create_strings_from_wikipedia,
                                   create_strings_randomly)
from main.utils import load_dict, load_fonts
def margins(margin):
...
def parse_arguments():
    ...
    parser.add_argument(
        "--output_dir", type=str, nargs="?", help="The output directory", default=r"output"
    )
    parser.add_argument(
        "-i",
        "--input_file",
    ...
    parser.add_argument(
        "-dt", "--dict", type=str, nargs="?", help="Define the dictionary to be used",default="double.txt"
    )
    parser.add_argument(
        "-ws",
        "--word_split",
    ...
    parser.add_argument(
        ...
        "--random_",
        action="store_true",
        help="whether to use random parameters",
        default=False
    )
...
def main():
    ...
    if args.random_==True:
        import random
        # args.stroke_width = random.randint(0, 2)
        args.format = random.randint(25, 60)
        # args.alignment = random.randint(0, 2)
        args.margins=(random.randint(-2,10),random.randint(-2,10),random.randint(-2,10),random.randint(-2,10))
        # args.space_width=random.random()*0.5
    try:
