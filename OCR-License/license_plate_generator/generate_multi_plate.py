...
class MultiPlateGenerator:
    ...
    def generate_plate_number(self):
        ...
        if rate > 0.4:
            ...
            # 白牌、黄牌教练车、黄牌挂车、黑色港澳、黑色使、领馆   使领港澳学警、新能源、蓝色都是单层
        ...
        if len(plate_number) == 8:
            ...
            bg_color = 'yellow'
############################xiugai
        is_double = random_select([True] + [True] * 3)
...
if __name__ == '__main__':
    ...
    for i in tqdm(range(args.number)):
        ...
        cv2.imencode(os.path.join(args.save_adr, '{}_{}_{}.jpg'.format(gt_plate_number, bg_color, is_double)), img)[1].tofile(os.path.join(args.save_adr, '{}_{}_{}.jpg'.format(gt_plate_number, bg_color, is_double)))
