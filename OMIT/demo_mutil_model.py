...
if __name__ == '__main__':
    ...
    input_img_path = r"F:\jishulin_data\paddle1\MS1M_v3_all\images_ir_rgb_mask"
    out_path=r"F:\jishulin_data\images_ir_rgb_mask"
            ...
            if batch_img is not None:
                ...
                for i in range(0,batch_img.shape[0],80):
                    ...
                    for img_fake,img_real in zip(img_fake_IR,batch_80_img):
                        ...
                        cv2.imwrite(os.path.join(roots,file_img_list[a].split(".")[0]+"_IR.jpg"), src_np_img[..., ::-1])
                        # print(os.path.join(roots,file_img_list[a].split(".")[0]+"_IR.jpg"))
                        f.write(os.path.join(roots,file_img_list[a].split(".")[0]+"_IR.jpg") + "\t" + str(scor)[1:-1]+ "\n")
                        a+=1
        except:
            continue